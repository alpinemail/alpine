...
DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/Makefile.am \
	...
	$(top_srcdir)/include/config.h.in mkinstalldirs ABOUT-NLS \
...
abs_builddir = /run/media/echappa/Alpine/alpine/alpinegit
abs_srcdir = /run/media/echappa/Alpine/alpine/alpinegit
...
ac_ct_DUMPBIN = 
acx_pthread_config = 
alpine_interactive_spellcheck = /usr/bin/hunspell
alpine_simple_spellcheck = /usr/bin/hunspell -l
am__include = include
am__leading_dot = .
am__quote = 
...
gssapi_proxy.l:
	if test ! -L c-client/auth_gss_proxy.c ; then $(LN_S) /run/media/echappa/Alpine/alpine/alpinegit/web/src/pubcookie/auth_gss_proxy.c c-client/auth_gss_proxy.c ; fi
