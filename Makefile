...
abs_builddir = /run/media/chappa/Work/alpine/alpinegit
abs_srcdir = /run/media/chappa/Work/alpine/alpinegit
...
gssapi_proxy.l:
	if test ! -L c-client/auth_gss_proxy.c ; then $(LN_S) /run/media/chappa/Work/alpine/alpinegit/web/src/pubcookie/auth_gss_proxy.c c-client/auth_gss_proxy.c ; fi
